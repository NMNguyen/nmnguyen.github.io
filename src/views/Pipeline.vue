<template>
    <div class="about d-flex flex-column" style="height: 100%">
                        ...
                        <div class="action btn-group dropdown">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <div>
                                    ...
                                    <div class="item">
                                        <i class="icon fa fa-circle draft"></i>
                                        <span>Draft</span>
                                    </div>
                                    <div class="item">
                                        <i class="icon fa fa-circle closed"></i>
                                        <span>Closed</span>
                                    </div>
                                    <div class="item">
            ...
            <div class="flex-right" style="float: right; height: 100%;">
                <div class="mainbar clearfix">
                    <div class="tabs-container">
                        <b-nav tab>
                            <b-nav-item to="#">Candidate</b-nav-item>
                            <b-nav-item to="/pipeline" activeClass="active">Pipeline</b-nav-item>
                            ...
                            <b-nav-item :to="'/positions/' + position.id + '/detail'">
        ...
        <header class="flex-shrink-0 p-3">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                    ...
                    <b-button class="mx-2" variant="primary" @click="setAddCandidateModalFlag(true)">
        ...
        <!-- Task content -->
        <div class="d-flex flex-grow-1 flex-shrink-1 align-items-start">
            <!-- Left border -->
            <FilterColumn :open="filterNav.open"/>
            <!-- Right border -->
            <div class="bzy-content" style="padding-left: 10px">
                <ul class="lists-container roomy" id="lists-container" scroll-on-drag="scroll-on-drag">
...
<script lang="ts">
    ...
    export default Vue.extend({
        ...
        methods: {
            ...mapMutations(['setAddCandidateModalFlag']),
        }
    });
</script>
